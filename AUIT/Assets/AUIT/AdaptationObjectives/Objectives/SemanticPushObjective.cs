...
namespace AUIT.AdaptationObjectives
{
    ...
    /// </summary>
    public class SemanticPushObjective : LocalObjective
    {
        [SerializeField]
        ...
        private float GetSemanticAgreement(float[] negativeAssociations, float[] distances)
        {
            ...
            return 0.5f * maxNegativeAssociationDistance;
        }

        private float GetSemanticMismatch(float[] negativeAssociations, float[] distances)
        {
            float semanticAgreement = GetSemanticAgreement(negativeAssociations, distances);
            if (normalize) {
        ...
        public override float CostFunction(Layout optimizationTarget, Layout initialLayout = null)
        {
            ...
            float semanticMismatch = GetSemanticMismatch(negativeAssociations, distances);
